...
const AuthPrez = ({ classes }) => (
  <Deck transition={["zoom", "slide"]} transitionDuration={500} theme={theme}>
    ...
    <Slide transition={["fade"]}>
      ...
      <p>3 types de processus d'identification</p>
    </Slide>
    <Slide transition={["fade"]}>
      <Heading size={6} textColor="tertiary" caps>
        OpenId Connect
      ...
      <List>
        <ListItem>
          ...
          différentes pour l'autorisation et l'obtention de tokens. Nécessite
    ...
    <Slide transition={["fade"]}>
      ...
      <List>
        <ListItem>
          <strong>Implicit Flow</strong> Les tokens sont retournés directement
          par la même interface et les utilisateurs ne s'enregistrent pas côté
